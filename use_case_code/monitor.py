...
class Monitor:
    ...
    def perform_earthquake_analytics(self, location=None, radius=None):
        ...
        closest_filtered = earthquake_analytics.get_closest_filtered_earthquake(location=location)
        place_of_closest_filtered = earthquake_analytics.get_place_of_closest_filtered_earthquake(location=location)
